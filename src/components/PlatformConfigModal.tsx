              ...
              <div className="space-y-4">
                <div className="flex flex-col gap-1.5">
                  ...
                  <input
                    ...
                    className="bg-slate-950 border border-slate-700 rounded px-3 py-2 text-sm text-slate-200 font-mono focus:border-emerald-500 outline-none w-full"
                  />
                </div>
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <input
                    ...
                    className="bg-slate-950 border border-slate-700 rounded px-3 py-2 text-sm text-slate-200 focus:border-emerald-500 outline-none w-full"
                  />
                </div>
              </div>
